...
E:\学习\数模相关\code_of_argorithm>python.exe -m pydoc 深圳杯C题\utils\tool.py 深圳杯C题\utils\RiskAnalyzer.py 深圳杯C题\utils\data_loder.py 
Help on module tool:
...
problem in 深圳杯C题\utils\RiskAnalyzer.py - ModuleNotFoundError: No module named 'utils'
...
DATA
    edges_file = r'E:\学习\数模相关\code_of_argorithm\深圳杯C题\data_file\edges_info...
    edges_info = [{(1, 2): {'Reactance': 0.0021, 'Resistor': 0.0031, 'leng...
    f = <_io.TextIOWrapper name='E:\\学习\\数模相关\\code_of_a...file\\nodes_inf...
    logger = <loguru.logger handlers=[(id=0, level=10, sink=<stderr>)]>
    nodes_file = r'E:\学习\数模相关\code_of_argorithm\深圳杯C题\data_file\nodes_info...
    nodes_info = {'1': {'DG': False, 'power': 40.0, 'type': '居民', 'which_s...

FILE
    e:\学习\数模相关\code_of_argorithm\深圳杯c题\utils\data_loder.py
